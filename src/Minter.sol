...
contract Minter is IMinter {
    ...
    IKitten public immutable _kitten;
    IVoter public immutable _voter;
    IVotingEscrow public immutable _ve;
    IRewardsDistributor public immutable _rewards_distributor;
    uint public weekly = 2020202020202020202021; // epoch 0, but represents a starting weekly emission (epoch 1) of 2,000 KITTEN (KITTEN has 18 decimals)
    ...
    function initialize(
        ...
        _kitten.mint(address(this), max);
        _kitten.approve(address(_ve), type(uint).max);
