...
import "openzeppelin-contracts-v3.4.2/contracts/proxy/Clones.sol";
import "openzeppelin-contracts-v3.4.2/contracts/proxy/Initializable.sol";
...
contract CLFactoryV2 is ICLFactory, Initializable {
    ...
    /// @inheritdoc ICLFactory
    IFactoryRegistry public override factoryRegistry;
    /// @inheritdoc ICLFactory
    ...
    /// @inheritdoc ICLFactory
    mapping(address => mapping(address => mapping(int24 => address)))
        public
        override getPool;
    ...
    function initialize(
        ...
        enableTickSpacing(1, 200);
        enableTickSpacing(200, 2_500);
        enableTickSpacing(2_000, 7_500);
    }
    ...
    function setUnstakedFeeManager(
        ...
        emit UnstakedFeeManagerChanged(
            cachedUnstakedFeeManager,
            _unstakedFeeManager
        );
    }
